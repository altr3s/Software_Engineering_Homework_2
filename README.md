...
5. **Уведомление в Telegram**:
    - **Уведомление о неудачном билде**: При неудачном выполнении тестов отправляется сообщение в
      Telegram с информацией о сбое и прикрепленным файлом `failure-report.txt`.
    - **Уведомление об успешном билде**: При успешном выполнении тестов отправляется сообщение в
      Telegram с информацией об успешном билде.
